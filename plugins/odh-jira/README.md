...
/plugin install odh-jira@odh-ai-helpers
```
...
- **jira-workitem-search** — Search Jira tickets using JQL queries.
- **jira-workitem-view** — Retrieve and display full details of a Jira ticket.
- **pr-jira-linker** — Find and link Jira issues to PRs/MRs that are missing Jira references.
- **triage-bug-readiness** — Use when assessing a Jira bug ticket for AI autofix readiness.
