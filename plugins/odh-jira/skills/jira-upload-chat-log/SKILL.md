...
3. If no ticket is found in context, ask the user: "Which JIRA ticket should I attach this chat log to? (e.g., RHAI-1234)"
...
### Basic Usage
```
User: Upload this chat to RHAI-7354
Assistant: [Skill creates formatted chat log and uploads to RHAI-7354]
```

### No Ticket Specified
```
User: Upload this conversation to JIRA
Assistant: Which JIRA ticket should I attach this chat log to? (e.g., RHAI-1234)
User: RHEL-9876
...
### Context Detection
```
User: We're working on RHAI-7354. Can you upload our conversation?
Assistant: [Skill detects RHAI-7354 from context and uploads automatically]
```